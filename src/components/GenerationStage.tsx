...
export const GenerationStage: React.FC<GenerationStageProps> = ({
  ...
  return (
    <div className="mx-auto max-w-6xl py-6 px-4 sm:px-6 space-y-6">
      {/* Top Banner */}
      <div className="glass-panel p-5 rounded-2xl border border-indigo-500/30 bg-indigo-950/20 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-600/30 text-indigo-400 border border-indigo-500/40">
            <Box className="h-5 w-5 text-amber-400 animate-pulse" />
          </div>
          <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-3">
          <div className="flex items-center justify-between mb-1">
            <h3 className="font-display text-sm font-bold uppercase tracking-wider text-slate-300 flex items-center gap-2">
        ...
        <div className="lg:col-span-5 space-y-4">
              ...
              {[
                ...
                <div key={i} className="space-y-1">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="font-mono text-[11px] text-indigo-400">{task.pct}%</span>
                  </div>
          ...
          <div className="glass-panel p-4 rounded-xl border border-white/10 font-mono text-[11px] space-y-2 bg-slate-950/90">
            <div className="flex items-center justify-between pb-2 border-b border-white/5 text-slate-400">
              <span>CINEGEN 3D AGENT TERMINAL</span>
